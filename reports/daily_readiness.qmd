...
today <- wellness %>%
  ...
  mutate(
    ...
    flags = paste(
      if_else(sleep_hours < 6.5, "⚠️ Poor Sleep", ""),
      if_else(fatigue_0_10 >= 7, "⚠️ High Fatigue", ""),
      if_else(soreness_0_10 >= 7, "⚠️ High Soreness", ""),
      sep = " "
    ) %>% str_squish()
  ) %>%
...
header_bar <- div(class = "topbar header",
  h1(class="title", "🏀 Daily Readiness Report"),
...
footer <- div(class="footer",
  p(tags$strong("WAIMS Monitoring System"), " | Daily Readiness Brief"),
